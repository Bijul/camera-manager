...
class ImageCaptureRaspistill final : public ImageCapture {
public:
    ImageCaptureRaspistill(std::shared_ptr<CameraDevice> camDev);
    ImageCaptureRaspistill(std::shared_ptr<CameraDevice> camDev, struct ImageSettings &imgSetting);
    ~ImageCaptureRaspistill();
